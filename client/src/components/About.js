                    ...
                    <div className="row">
                        ...
                        <div className="col-md-8 pl-5">
                            ...
                            <input type="radio" className="tabs__radio" name="tabs-example" id="tab1" checked/>
                                <label htmlFor="tab1" className="tabs__label">About</label>
                                ...
                                <label htmlFor="tab2" className="tabs__label">Timeline</label>
                                <div className="tabs__content">
                                <div className="tabs__content_content">
                                    ...
                                    <div className="about-title-value">JNR. WEB DEV, HOTELHUB</div>
                                    </div>

                                    <div className="tabs__content_content">
                                    <div className="about-title">2022</div>
                                    <div className="about-title-value">SNR. WEB DEV, HOTELHUB</div>
                                    </div>
                                </div>
